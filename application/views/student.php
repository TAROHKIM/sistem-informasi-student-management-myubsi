...
<ol class="breadcrumb">
  ...
  if($this->input->get('opt') == 'addst') {
    echo '<li class="active">Tambah Mahasiswa</li>';
  } 
  else if ($this->input->get('opt') == 'bulkst') {
    echo '<li class="active">Tambah Banyak Mahasiswa</li>';
  }
  else if ($this->input->get('opt') == 'mgst') {
    echo '<li class="active">Kelola Mahasiswa</li>';
  }
  ?>  
  ...
  <div class="panel-body">
      ...
      if($this->input->get('opt') == 'addst') {
        ...
        <form action="<?php echo base_url('student/create') ?>" method="post" id="createStudentForm" enctype="multipart/form-data">  
          ...
          <fieldset>
            <legend>Info Pendaftaran</legend>

            <div class="form-group">
              <label for="registerDate">Tanggal</label>
              <input type="text" class="form-control" id="registerDate" name="registerDate" placeholder="Tanggal" autocomplete="off">
            </div>
            <div class="form-group">
              <label for="className">Prodi</label>
            ...
            <div class="form-group">
              <label for="sectionName">Kelas</label>
           ...
           <tbody>
            ...
            for($x = 1; $x < 4; $x++) { ?>
              <tr id="row<?php echo $x; ?>">
                <td>
                  <div class="form-group">
                    <input type="text" class="form-control" id="bulkstfname<?php echo $x; ?>" name="bulkstfname[<?php echo $x; ?>]" placeholder="Nama Depan" autocomplete="off">
                  </div>                  
                </td>
                <td>
                  <div class="form-group">
                    <input type="text" class="form-control" id="bulkstlname<?php echo $x; ?>" name="bulkstlname[<?php echo $x; ?>]" placeholder="Nama Belakang" autocomplete="off">
                  </div>                  
                </td>
                <td>
                  <div class="form-group">
...
<?php 
  ...
  <div class="row">
          ...
          <div class="col-md-8">              
            ...
            <div class="panel panel-default">
              <div class="panel-heading">Kelola Mahasiswa</div>
              <div class="panel-body">
                <div id="result"></div>                                        
