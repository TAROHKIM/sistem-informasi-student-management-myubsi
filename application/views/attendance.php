...
<ol class="breadcrumb">
  ...
  if($this->input->get('atd') == 'add') {
    echo '<li class="active">Buka Absensi</li>';
  } 
  else if ($this->input->get('atd') == 'report') {
    echo '<li class="active">Laporan Absensi</li>';
  }  
  ?>  
</ol>
      ...
      if($this->input->get('atd') == 'add') {
        ...
        <form class="form-horizontal" method="post" id="getAttendanceForm">
		  <div class="form-group">
		    <label for="type" class="col-sm-2 control-label">Pilih Absensi</label>
		    <div class="col-sm-10">
