	...
	*/
	public function fetchMarksheetTable($classId = null)
	{
		if($classId) {			
			...
			<div class="well">
				Prodi : '.$classData['class_name'].'
			</div>

			<div id="messages"></div>

			<div class="pull pull-right">
	  			<button class="btn btn-success" data-toggle="modal" data-target="#addMarksheetModal" onclick="addMarksheet('.$classId.')">Tambah Penilaian</button>	
		  	</div>
