	...
	*/
	public function fetchAttendaceType($id = null) 
	{
		if($id == 1) {
		    ...
		    <label for="className" class="col-sm-2 control-label">Prodi</label>
		    <div class="col-sm-10">
		  ...
		  <div class="form-group">
		    <label for="sectionName" class="col-sm-2 control-label">Kelas</label>
		    <div class="col-sm-10">
		      <select class="form-control" name="sectionName" id="sectionName">
		      	<option value="">Pilih Kelas Prodi Terlebih Dahulu</option>		      	
		      </select>
		    </div>
		  </div>
		  <div class="form-group">
	...
	*/
	...
	{	
		if($typeId == 1) {
		    ...
		    <div class="well">
		    	Tipe Absensi : Mahasiswa <br />
		    	Prodi : '.$classData['class_name'].' <br />
		    	Kelas : '.$sectionData['section_name'].' <br /> 
		    </div>		
				    		...
				    		$div .= '<tr>
				    			...
				    			<td>
				    				<select name="attendance_status['.$x.']" id="attendance_status" class="form-control">
										...
										$div .= '>Tidak Hadir</option>
				    					<option value="3" '; 
										if($attedanceData['mark'] == 3) {
											$div .= 'selected';
										}
										$div .= '>Terlambat</option>
				    				</select>
				    			</td>
				    		</tr>';
				    		$x++;
