		...
		if($type == 1) {
			...
			$div = '<form class="form-horizontal" action="accounting/createIndividual" method="post" id="createIndividualForm">	    	
		  	<div class="form-group">
		    	<label for="className" class="col-sm-2 control-label">Nama Prodi</label>
		    	<div class="col-sm-10">
		  	...
		  	<div class="form-group">
		    	<label for="sectionName" class="col-sm-2 control-label">Nama Kelas</label>
		    	<div class="col-sm-10">
		  	...
		  	<div class="form-group">
		    	<label for="studentName" class="col-sm-2 control-label">Mahasiswa</label>
		    	<div class="col-sm-10">
		  	...
		  	<div class="form-group">
		    	<label for="paymentName" class="col-sm-2 control-label">Nama Pembayaran</label>
		    	<div class="col-sm-10">
		      		<input type="text" class="form-control" id="paymentName" name="paymentName" placeholder="Nama Pembayaran">
		    	</div>
		  	</div>
		  	<div class="form-group">
		    	<label for="startDate" class="col-sm-2 control-label">Tanggal Mulai</label>
		    	<div class="col-sm-10">
		      		<input type="text" class="form-control" id="startDate" name="startDate" placeholder="Tanggal Mulai">
		    	</div>
		  	</div>
		  	<div class="form-group">
		    	<label for="endDate" class="col-sm-2 control-label">Tanggal Selesai</label>
		    	<div class="col-sm-10">
		      		<input type="text" class="form-control" id="endDate" name="endDate" placeholder="Tanggal Selesai">
		    	</div>
		  	</div>
		  	<div class="form-group">
		    	<label for="totalAmount" class="col-sm-2 control-label">Total Biaya</label>
		    	<div class="col-sm-10">
		      		<input type="text" class="form-control" id="totalAmount" name="totalAmount" placeholder="Total Biaya">
		    	</div>
		  	</div>
			<div class="form-group">
			...
			<div class="col-sm-6">
				<div class="form-group">
			  	...
			  	<div class="form-group">
			    	<label for="totalAmount" class="col-sm-2 control-label">Biaya</label>
			    	<div class="col-sm-10">
			      		<input type="text" class="form-control" id="totalAmount" name="totalAmount" placeholder="Biaya">
			    	</div>
			  	</div>
			</div>
			<!--/.col-sm-6--> 
			...
			<div class="col-sm-6">
				...
				<table id="studentName" class="table table-hover table-bordered">
					...
					<tbody>
						<tr>
							<td colspan="2"><center>Pilih Prodi & Kelas Terlebih Dahulu</center></td>	
						</tr>
					</tbody>
				</table>
			</div>
	...
	public function fetchUpdatePaymentForm($type = null)
	{
		...
		if($type == 1) {
			$option = '<form class="form-horizontal" action="accounting/updatePayment" method="post" id="updatePaymentFrom">	    	
		  	<div class="form-group">
		    	<label for="editClassName" class="col-sm-2 control-label"></label>
		    	<div class="col-sm-10">
			...
			$option = '<form class="form-horizontal" action="accounting/updatePayment" method="POST" id="updatePaymentFrom">
	      	...
	      	<div class="col-md-6">
				...
				<div class="form-group">
			    	<label for="editClassName" class="col-sm-4 control-label"></label>
			    	<div class="col-sm-8">
			      		<select class="form-control" name="editClassName" id="editClassName">      	
			      			<option value="">Select Class</option>';			      			
			      			foreach ($classData as $key => $value) {
